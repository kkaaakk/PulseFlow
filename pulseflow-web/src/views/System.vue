...
<template>
  <div class="page-heading"><div><h1>System</h1><p>轻量运维观察：只展示组件状态，不暴露任何敏感配置。</p></div><button class="secondary-button" :disabled="loading" @click="load">{{ loading ? '刷新中…' : '刷新状态' }}</button></div>
